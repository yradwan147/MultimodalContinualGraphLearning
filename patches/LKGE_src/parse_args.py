...
# training control
parser.add_argument('-snapshot_num', dest='snapshot_num', type=int, default=5, help='The snapshot number of the dataset')
...
parser.add_argument('-epoch_num', dest='epoch_num', type=int, default=200, help='max epoch num')
parser.add_argument('-margin', dest='margin', type=float, default=8.0, help='The margin of MarginLoss')
parser.add_argument('-batch_size', dest='batch_size', type=int, default=2048, help='Mini-batch size')
...
parser.add_argument('-neg_ratio', dest='neg_ratio', type=int, default=10, help='the ratio of negative/positive facts')
parser.add_argument('-patience', dest='patience', type=int, default=3, help='early stop step')
parser.add_argument('-regular_weight', dest='regular_weight', type=float, default=0.01, help='Regularization strength: alpha')
parser.add_argument('-reconstruct_weight', dest='reconstruct_weight', type=float, default=0.1, help='The weight of MAE loss: beta')
...
parser.add_argument('-seed', dest='seed', type=int, default=55, help='random seed, 11 22 33 44 55 for our experiments')
